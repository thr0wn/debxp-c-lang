...
O arquivo [salve.c](build/aula1/salve.c) exibe uma string.
...
O arquivo [var1.c](aula4/var1.c) exibe valores de variáveis.
O arquivo [var2.c](aula4/var2.c) exibe valores de váriaveis, endereços, tamanhos e valores.
O arquivo [var3.c](aula4/var3.c) não compila por problemas de escopo propositais.
O arquivo [var4.c](aula4/var4.c) aritmética de ponteiros.
